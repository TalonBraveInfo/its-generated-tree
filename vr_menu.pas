...
{ VRM_GetScreen 112B:0139 }
procedure VRM_GetScreen();

begin
{ stub }
end;

{ VRM_FreeScreen 112B:02AB }
procedure VRM_FreeScreen();
...
{ VRM_CheckPickableObjectBuffer 112B:2610 }
procedure VRM_CheckPickableObjectBuffer();

begin
{ stub }
end;

{ VRM_ShowDBScreen 112B:3625 }
procedure VRM_ShowDBScreen();

begin
{ stub }
end;

{ VRM_ShowScreen 112B:364C }
procedure VRM_ShowScreen();

begin
{ stub }
end;

{ VRM_MainMenu 112B:371A }
procedure VRM_MainMenu();

begin
{ stub }
end;

{ VRM_GameText 112B:3E53 }
procedure VRM_GameText();

begin
{ stub }
end;

{ VRM_GameTextDraw 112B:3F53 }
procedure VRM_GameTextDraw();

begin
{ stub }
end;

{ VRM_UpdateStatusBar 112B:41CE }
procedure VRM_UpdateStatusBar();
...
{ UpdatePickableObjects 1571:07C4 import }
{ RunObjectManager 1571:0820 import }
{ EventPressed 1571:08DC import }
{ ScanEvent 1571:092A import }
{ ScanEventTime 1571:09B5 import }
{ MetaPressed 1571:0A6E import }
{ ScanMeta 1571:0A86 import }
{ StartMovementManager 1571:0C8D import }
{ StopMovementManager 1571:0D13 import }

{ SaveGameInputDone 194F:01D4 import }
