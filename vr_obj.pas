...
{ VROBJ_DangerLinkObject 3409:00EC }
procedure VROBJ_DangerLinkObject();

begin
{ stub }
end;

{ VROBJ_DangerUnlinkObject 3409:0102 }
procedure VROBJ_DangerUnlinkObject();

begin
{ stub }
end;

{ VROBJ_AddObject 3409:017B }
procedure VROBJ_AddObject();

begin
{ stub }
end;

{ VROBJ_RemoveObject 3409:01B7 }
procedure VROBJ_RemoveObject();

begin
{ stub }
end;

{ VROBJ_SetObjectPosition 3409:01E1 }
procedure VROBJ_SetObjectPosition();

begin
{ stub }
end;

{ VROBJ_ScanObjectBitmapCrossLinking 3409:02CF }
procedure VROBJ_ScanObjectBitmapCrossLinking();

begin
{ stub }
end;

{ VROBJ_RunPassiveObjects 3409:0419 }
procedure VROBJ_RunPassiveObjects();

begin
{ stub }
end;

{ VROBJ_RunActiveObjects 3409:0467 }
procedure VROBJ_RunActiveObjects();

begin
{ stub }
end;

{ VROBJ_AllertArea 3409:04A7 }
procedure VROBJ_AllertArea();

begin
{ stub }
end;

{ VROBJ_AllertAreaVec32 3409:0555 }
procedure VROBJ_AllertAreaVec32();

begin
{ stub }
end;

{ VROBJ_CheckAllertedArea 3409:05B5 }
procedure VROBJ_CheckAllertedArea();

begin
{ stub }
end;

{ VROBJ_ForAllObjectsDo 3409:067B }
procedure VROBJ_ForAllObjectsDo();

begin
{ stub }
end;

{ VROBJ_UpdateObjectPosition 3409:0761 }
procedure VROBJ_UpdateObjectPosition();

begin
{ stub }
end;

{ VROBJ_UpdateObjectAt 3409:07D3 }
procedure VROBJ_UpdateObjectAt();

begin
{ stub }
end;

{ VROBJ_CheckObjectPositionExcludeObjects 3409:0855 }
procedure VROBJ_CheckObjectPositionExcludeObjects();

begin
{ stub }
end;

{ VROBJ_ID2Obj 3409:08C6 }
procedure VROBJ_ID2Obj();

begin
{ stub }
end;

{ VROBJ_SetObjectType 3409:08F6 }
procedure VROBJ_SetObjectType();

begin
{ stub }
end;

{ VROBJ_KillInterpolation 3409:0946 }
procedure VROBJ_KillInterpolation();

begin
{ stub }
end;

{ VROBJ_ClearAllObjects 3409:097F }
procedure VROBJ_ClearAllObjects();

begin
{ stub }
end;

{ VROBJ_SetupObject 3409:0A58 }
procedure VROBJ_SetupObject();

begin
{ stub }
end;

{ VROBJ_InitializePlayer 3409:0F2F }
procedure VROBJ_InitializePlayer();

begin
{ stub }
end;

{ VROBJ_Init 3409:115B }
procedure VROBJ_Init();
