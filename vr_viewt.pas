...
{ VT_LoadShadeTable 3666:0028 }
procedure VT_LoadShadeTable();

begin
{ stub }
end;

{ VT_LoadColorMixTable 3666:00FB }
procedure VT_LoadColorMixTable();

begin
{ stub }
end;

{ VT_LoadColorAddTable 3666:01B2 }
procedure VT_LoadColorAddTable();
