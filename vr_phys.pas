...
{ PointOnLineSide 31A2:0000 }
procedure PointOnLineSide();
...
{ GetTiltedNormal 31A2:08C1 }
procedure GetTiltedNormal();

begin
{ stub }
end;

{ CheckBSPTree 31A2:0A57 }
procedure CheckBSPTree();

begin
{ stub }
end;

{ VRPH_AddPickableObject 31A2:0A6C }
procedure VRPH_AddPickableObject();

begin
{ stub }
end;

{ VRPH_InitPickableObjectBuffer 31A2:0AEF }
procedure VRPH_InitPickableObjectBuffer();

begin
{ stub }
end;

{ VRPH_PickableHandlerInitFrame 31A2:0B38 }
procedure VRPH_PickableHandlerInitFrame();

begin
{ stub }
end;

{ CheckPickableObjects 31A2:0B6F }
procedure CheckPickableObjects();

begin
{ stub }
end;

{ CheckCylinder 31A2:0F86 }
procedure CheckCylinder();

begin
{ stub }
end;

{ CheckPoint 31A2:11A4 }
...
{ GetFloorHeight 31A2:131B }
procedure GetFloorHeight();

begin
{ stub }
end;

{ Intersectline 31A2:1351 }
procedure Intersectline();

begin
{ stub }
end;

{ PossibleLinePassage 31A2:1910 }
procedure PossibleLinePassage();

begin
{ stub }
end;

{ IntersectSphere 31A2:1DE3 }
procedure IntersectSphere();

begin
{ stub }
end;

{ ClosestBall 31A2:2126 }
procedure ClosestBall();

begin
{ stub }
end;

{ BoundBallStructure 31A2:2285 }
procedure BoundBallStructure();

begin
{ stub }
end;

{ CalcAproxSphereVolume 31A2:23CE }
procedure CalcAproxSphereVolume();

begin
{ stub }
end;

{ IntersectBallStructure 31A2:24D7 }
procedure IntersectBallStructure();

begin
{ stub }
end;

{ ExtractBalls 31A2:2530 }
procedure ExtractBalls();

begin
{ stub }
end;

{ VR_PhysInit 31A2:2645 }
procedure VR_PhysInit();
