...
{ WriteSpriteTruncated 1D28:0C7D }
procedure WriteSpriteTruncated();

begin
{ stub }
end;

{ WriteShadeSprite 1D28:0DAB }
procedure WriteShadeSprite();

begin
{ stub }
end;

{ VRW_TweakInit 1D28:11AF }
procedure VRW_TweakInit();

begin
{ stub }
end;

{ VRW_LoadSpriteImage 1D28:1514 }
procedure VRW_LoadSpriteImage();
