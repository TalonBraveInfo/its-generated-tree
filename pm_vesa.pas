...
{ VESA_SetBank 3909:0015 }
procedure VESA_SetBank();

begin
{ stub }
end;

{ VESA_SetBankOptimal 3909:0063 }
procedure VESA_SetBankOptimal();

begin
{ stub }
end;

{ VESA_GetModeInfo 3909:00AA }
...
{ VESA_SetMode 3909:00F9 }
procedure VESA_SetMode();
...
{ VESA_Present 3909:01E8 }
procedure VESA_Present();
