...
{ MOVIE_Dummy 0787:0000 }
procedure MOVIE_Dummy();

begin
{ stub }
end;

{ CS_CharacterDemo1GetCamera 0787:0233 }
procedure CS_CharacterDemo1GetCamera();

begin
{ stub }
end;

{ CS_CharacterDemo1 0787:035C }
procedure CS_CharacterDemo1();

begin
{ stub }
end;

{ CS_CharacterDemo1Close 0787:04ED }
procedure CS_CharacterDemo1Close();

begin
{ stub }
end;

{ AI_RunCharacter 0B1D:0822 import }

{ VRAC_ExecuteEvent 0BAF:0CF9 import }
{ VRAC_IntersectBallStructure 0BAF:0FA3 import }
{ VRAC_HurtCreature 0BAF:1219 import }
{ VRAC_HurtCreatureVec32 0BAF:147D import }
{ VRAC_AnimProc_Intelligent 0BAF:19CB import }
{ VRAC_RunObject 0BAF:1F7B import }
{ VRAC_CalcAnimConsts 0BAF:2413 import }
{ VRAC_String2KeyCombo 0BAF:2DDE import }
{ VRAC_UpdateCharacterAttributes 0BAF:4905 import }
{ VRAC_CheckTemporaryAttributes 0BAF:4C70 import }
{ VRAC_SetupIntelligentObjects 0BAF:4D1E import }
{ VRAC_Init 0BAF:4F73 import }
