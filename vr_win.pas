...
{ SmallFigures 196E:0016 }
procedure SmallFigures();
...
{ RunDesktop 196E:2871 }
procedure RunDesktop();

begin
{ stub }
end;

{ RelocateGroup 196E:3678 }
procedure RelocateGroup();

begin
{ stub }
end;

{ UnRelocateGroup 196E:37E6 }
procedure UnRelocateGroup();
