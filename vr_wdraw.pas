...
{ VRWD_DrawListManager 2A6A:0000 }
procedure VRWD_DrawListManager();

begin
{ stub }
end;

{ VRWD_CheckNRoomCrd 2A6A:0E59 }
procedure VRWD_CheckNRoomCrd();

begin
{ stub }
end;

{ VRWD_CheckConstrRooms 2A6A:0EDA }
procedure VRWD_CheckConstrRooms();

begin
{ stub }
end;

{ VRWD_RotateRoom 2A6A:0F1E }
procedure VRWD_RotateRoom();

begin
{ stub }
end;

{ VRWD_BuildRoomSortList 2A6A:1143 }
procedure VRWD_BuildRoomSortList();

begin
{ stub }
end;

{ VRWD_FindStartRoom 2A6A:11CA }
procedure VRWD_FindStartRoom();

begin
{ stub }
end;

{ VRWD_RoomVisInit 2A6A:11F2 }
procedure VRWD_RoomVisInit();

begin
{ stub }
end;

{ VRWD_RoomRotate2DVec 2A6A:123D }
procedure VRWD_RoomRotate2DVec();

begin
{ stub }
end;

{ VRWD_RoomVisible 2A6A:12AF }
procedure VRWD_RoomVisible();

begin
{ stub }
end;

{ VRWD_GetRoom 2A6A:14A3 }
procedure VRWD_GetRoom();

begin
{ stub }
end;

{ VRWD_InitLevelTables 2A6A:14F9 }
procedure VRWD_InitLevelTables();

begin
{ stub }
end;

{ VRWD_SearchNewLevels 2A6A:1542 }
procedure VRWD_SearchNewLevels();

begin
{ stub }
end;

{ VRWD_RemoveFinishedLevelClipTabs 2A6A:15D9 }
procedure VRWD_RemoveFinishedLevelClipTabs();

begin
{ stub }
end;

{ VRWD_InitTables 2A6A:15FC }
procedure VRWD_InitTables();

begin
{ stub }
end;

{ VRWD_LightManager 2A6A:1636 }
procedure VRWD_LightManager();
