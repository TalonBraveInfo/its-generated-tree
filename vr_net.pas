...
{ ReadPlayerPosition 1571:0000 }
procedure ReadPlayerPosition();

begin
{ stub }
end;

{ UpdatePickableObjects 1571:07C4 }
procedure UpdatePickableObjects();

begin
{ stub }
end;

{ RunObjectManager 1571:0820 }
procedure RunObjectManager();

begin
{ stub }
end;

{ EventPressed 1571:08DC }
procedure EventPressed();
...
{ ScanEventTime 1571:09B5 }
procedure ScanEventTime();

begin
{ stub }
end;

{ MetaPressed 1571:0A6E }
procedure MetaPressed();
...
{ StartMovementManager 1571:0C8D }
procedure StartMovementManager();

begin
{ stub }
end;

{ StopMovementManager 1571:0D13 }
procedure StopMovementManager();
