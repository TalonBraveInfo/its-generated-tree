...
{ ProcFTMainSelect 1660:0000 }
procedure ProcFTMainSelect();

begin
{ stub }
end;

{ ProcVRLoadGame 1660:01B9 }
procedure ProcVRLoadGame();

begin
{ stub }
end;

{ ProcVRSaveGame 1660:04F3 }
procedure ProcVRSaveGame();

begin
{ stub }
end;

{ ProcVRConfig 1660:09AE }
procedure ProcVRConfig();

begin
{ stub }
end;

{ ProcVRSoundConfig 1660:1058 }
procedure ProcVRSoundConfig();

begin
{ stub }
end;

{ ProcVRItem 1660:1694 }
procedure ProcVRItem();

begin
{ stub }
end;

{ ProcVRHelp 1660:1EF6 }
procedure ProcVRHelp();

begin
{ stub }
end;

{ ProcVRMonster 1660:24C4 }
procedure ProcVRMonster();

begin
{ stub }
end;

{ ProcVRGfxModes 1660:2BA5 }
procedure ProcVRGfxModes();
