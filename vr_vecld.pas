...
{ VRVEC_CameraReset 352D:0000 }
procedure VRVEC_CameraReset();

begin
{ stub }
end;

{ VRVEC_InitFrame 352D:002C }
procedure VRVEC_InitFrame();

begin
{ stub }
end;

{ VRVEC_Draw 352D:00F5 }
procedure VRVEC_Draw();

begin
{ stub }
end;

{ VRVEC_SetModulo 352D:010A }
procedure VRVEC_SetModulo();

begin
{ stub }
end;

{ VRVEC_SetViewPort 352D:0120 }
procedure VRVEC_SetViewPort();

begin
{ stub }
end;

{ VRVEC_InitHDVArr 352D:038F }
procedure VRVEC_InitHDVArr();

begin
{ stub }
end;

{ VRVEC_LoadHDV 352D:0BD1 }
procedure VRVEC_LoadHDV();

begin
{ stub }
end;

{ VRVEC_Free 352D:0DE5 }
procedure VRVEC_Free();

begin
{ stub }
end;

{ VRVEC_Init 352D:0EAF }
procedure VRVEC_Init();
